...
int main(int argc, char **argv)
{
   ...
   /// Input 2pt-correlators (If calculate the R-correlators) ///
   ...
   ///     Input & Output NBS wave functions      ///
   /// (And construct R-correlator, if calculate) ///
   ...
   if (calc_flg_Rcorr)   Rcorr = new CONFIG<R_CORRELATOR>;
