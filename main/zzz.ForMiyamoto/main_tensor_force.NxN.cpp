 ...
 * @file
 * @ingroup potential
 * @brief   Main part for NxN coupled channel tensor potential calculation
...
#define PROJECT CALC_TENSOR_FORCE_NxN // <- Project name

#define IT(iii,ttt) ((iii)+ Ndim* (ttt))
#define RC(Row,Colomn) ((Colomn)+ Ndim* (Row))

static int    Ndim;
static int    time_slice;
static double *mass     = NULL;
static double *Zfactor  = NULL;
