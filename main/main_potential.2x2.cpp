...
static int set_args_from_file(char* file_name) {
   ...
   for (int loop=0; loop<count; loop++) {
      if (sscanf(tmp_str[loop]," %s = %s ",tmp_c1,tmp_c2) != 2)
         continue;
      //****** You may set additional potion in here ******//
      if (     strcmp(tmp_c1,"CCP2_Size_of_space"      )==0){
         analysis::xSIZE = atoi(tmp_c2);
         analysis::ySIZE = atoi(tmp_c2);
         analysis::zSIZE = atoi(tmp_c2);
      }
      else if (strcmp(tmp_c1,"CCP2_Size_of_time"       )==0)
         analysis::tSIZE = atoi(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_calc_time_slice"    )==0)
         time_slice = atoi(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Spin_projection"    )==0)
         spin.set(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Gauge_confs_list"   )==0)
         snprintf(conf_list,sizeof(conf_list),"%s",tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Path_to_output_dir" )==0)
         snprintf(outfile_path,sizeof(outfile_path),"%s",tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Path_to_input_dir"  )==0)
         analysis::set_data_list(MAIN_PATH, "%s", tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_T_shift"            )==0)
         analysis::set_data_list(N_T_SHIFT, "%s", tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_X_shift"            )==0)
         analysis::set_data_list(N_X_SHIFT, "%s", tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Y_shift"            )==0)
         analysis::set_data_list(N_Y_SHIFT, "%s", tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Z_shift"            )==0)
         analysis::set_data_list(N_Z_SHIFT, "%s", tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Snk_relativistic"   )==0)
         analysis::set_data_list(SNK_RELA, "%s", tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Src_relativistic"   )==0)
         analysis::set_data_list(SRC_RELA, "%s", tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Take_jack_knife"    )==0)
         take_JK_flg = analysis::str_to_bool(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Use_jack_knife_data")==0)
         use_JK_data = analysis::str_to_bool(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_channel_00"         )==0)
         channels[0].set(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_channel_01"         )==0)
         channels[1].set(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_channel_10"         )==0)
         channels[2].set(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_channel_11"         )==0)
         channels[3].set(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_mass_ch0-0"         )==0)
         mass[0] = atof(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_mass_ch0-1"         )==0)
         mass[1] = atof(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_mass_ch1-0"         )==0)
         mass[2] = atof(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_mass_ch1-1"         )==0)
         mass[3] = atof(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Z_factor_01"        )==0)
         Zfactor[idx(0,1)] = atof(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Out_fit_data"       )==0)
         calc_flg_fit = analysis::str_to_bool(tmp_c2);
      else if (strcmp(tmp_c1,"CCP2_Out_all_data"       )==0)
