 ...
 * @since   Fri Dec 18 00:39:57 JST 2015
 */
//--------------------------------------------------------------------------
 ...
 */
//--------------------------------------------------------------------------
void NBSwave::spin_projection(  NBS_WAVE_ORG &orgNBS, NBS_WAVE_SRC_PRJ &NBS
                              , SPIN_TYPE spin ) {
...
void NBSwave::spin_projection(  NBS_WAVE_SRC_PRJ &srcprjNBS, NBS_WAVE &NBS
                              , SPIN_TYPE spin ) {
...
void NBSwave::spin_projection(  NBS_WAVE_ORG &orgNBS, NBS_WAVE &NBS
                              , SPIN_TYPE spin ) {
 ...
 */
//--------------------------------------------------------------------------
void NBSwave::remove_angular( NBS_WAVE &NBS, int m, double factor ) {
 ...
 */
//--------------------------------------------------------------------------
void NBSwave::S12_psi(  NBS_WAVE_SRC_PRJ &srcprjNBS, NBS_WAVE &NBS
                      , SPIN_TYPE spin ) {
